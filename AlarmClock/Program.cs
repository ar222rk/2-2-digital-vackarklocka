...
namespace AlarmClock
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            AlarmClock T1 = new AlarmClock(); //skapar ny instans utav AlaR,, 
            Console.WriteLine(T1.ToString()); // tostring metoden för att kunna få ut metoden
            ...
            private static void Run( AlarmClock ac, int minutes) // skapar metoden Run som jag ska använda för att skriva ut
            {
            ...
            private static void ViewErrorMessage(string message) // här skapas ViewErrorMessage 
            {
